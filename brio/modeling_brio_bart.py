...
class BrioBartForConditionalGeneration(BartForConditionalGeneration):
    def __init__(self, config: BartConfig):
        super().__init__(config)
        self.model = BrioBartModel(config)
    ...
    def forward(
        ...
        input_ids=None,
        attention_mask=None,
        decoder_input_ids=None, # [bs,1+num_candidates,seq_len] for training [bs,seq_len] for inference
        decoder_attention_mask=None,
        head_mask=None,
        decoder_head_mask=None,
        cross_attn_head_mask=None,
