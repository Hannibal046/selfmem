...
class DualEncoderPegasusModel(PegasusModel):
    def __init__(self, config: PegasusConfig):
        ...
        self.encoder = DualPegasusEncoder(config, self.shared)
        self.decoder = DualCrossAttnPegasusDecoder(config, self.shared)
